...
* I committed a total of 6 times. The average size isn't significant because, aside from the first commit, the rest of my commits were usually just tweaks or debugging changes. Though more consistent committing would have been much better, for me as a person, I have a preference to only commit when I feel I have something commit-worthy, when I have accomplished something significant. Unfortunately, those accomplishments tend to be few and far between, and hence the infrequent commits and pushes.
